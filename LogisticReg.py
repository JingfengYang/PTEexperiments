...
def LR(train_label_file,train_text_file,test_label_file,test_text_file,sent_ebd_file,all_text_file):
    #sent=utils.Sent()
    train_set,test_set=utils.readData(train_label_file,train_text_file,test_label_file,test_text_file,sent_ebd_file,all_text_file)
...
if __name__ == "__main__":
    ...
    y_pred_125,y_test_125=LR(train_label_file='data/mr/label_train.125.txt',train_text_file='data/mr/text_train.txt',
             test_label_file='data/mr/label_test.txt',test_text_file='data/mr/text_test.txt',
    ...
    y_pred_all, y_test_all = LR(train_label_file = 'data/dblp/label_train.txt',train_text_file = 'data/dblp/text_train.txt',
